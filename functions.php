...
function list_comments( $comment, $args, $depth ) {
    ...
    if ( 'div' != $args['style'] ) { ?>
        ...
        if ( $comment->comment_approved == '0' ) { ?>
            <em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'fredo' ); ?></em><br/><?php
        } ?>
...
function fredo_home_intro() {
	...
	<div class="row content">
		<div class="column">
			<h1><?php _e( 'Looking for some WordPress and WooCommerce related stuff? I got you covered! I\'m Remi, nice to meet you.', 'fredo' ); ?></h1>
			<p>
				<?php _e( 'Here is my blog, where I write from to time to time, where I give free snippets, where I share my skills. I work at Automattic, and guess what? We\'re hiring!', 'fredo' ); ?>
			</p>
		</div>
	</div>
	<?php
...
function fredo_promote_theme_box() {
	...
	<div class="row section-title">
		<div class="column">
			<h2><span><?php _e(' Like this theme?', 'fredo' ); ?></span></h2>
		</div>
	</div>

	<div class="row theme">
		<div class="column">
			<span class="title"><?php _e( 'It\'s free an open source!', 'fredo' ); ?></span>
			<span class="description"><?php _e( 'This theme is clean, fast and doesn\'t rely on any heavy technology. I wanted it to be simple to use, clearly readable and focusing on content. No need for useless featured images, visual effects, preloaders or any other fancy trendy stuff. Nobody cares about this anymore.', 'fredo' ); ?></span>
		</div>
	</div>
	<div class="row">
		<div class="column">
			<span class=""><a class="button button-outline" href="https://github.com/corsonr/fredo/archive/master.zip" target="_blank"><?php _e( 'Download', 'fredo' ); ?></a></span>
		</div>
		<div class="column">
			<span class=""><a class="button button-outline" href="https://github.com/corsonr/fredo/issues" target="_blank"><?php _e( 'Report a bug', 'fredo' ); ?></a></span>
		</div>
		<div class="column">
			<span class=""><a class="button button-outline" href="https://github.com/corsonr/fredo/blob/master/CONTRIBUTING.md" target="_blank"><?php _e( 'Contribute', 'fredo' ); ?></a></span>
		</div>
		<div class="column">
			<span class="support"><a class="button button-outline" href="<?php echo fredo_buy_me_a_coffee_url(); ?>" target="_blank"><?php _e( 'Buy me a coffee', 'fredo' ); ?></a></span>
		</div>
	</div>
	<?php
}
